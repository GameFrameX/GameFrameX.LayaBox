...
$root.Bag = (function() {
    ...
    Bag.ResBagInfo = (function() {
        ...
        ResBagInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Bag.ResBagInfo(), key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    ...
                    key = reader.int32();
                    reader.pos++;
                    message.ItemDic[key] = reader.int64();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    Bag.ResItemChange = (function() {
        ...
        ResItemChange.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Bag.ResItemChange(), key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
...
$root.common = (function() {
    ...
    common.PhoneNumber = (function() {
        ...
        PhoneNumber.toObject = function toObject(message, options) {
            ...
            if (message.type != null && message.hasOwnProperty("type"))
                object.type = options.enums === String ? $root.common.PhoneType[message.type] : message.type;
            return object;
        };
